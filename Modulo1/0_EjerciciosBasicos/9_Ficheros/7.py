...
# y devuelva un diccionario con los datos del fichero por 
# columnas.

# Construir una función que reciba el diccionario 
# devuelto por la función anterior y cree un fichero 
# en formato csv con el mínimo, el máximo y la media 
# de dada columna.
...
cotizaciones = preprocesado('9_ficheros/cotizacion.csv')
print(cotizaciones)
resumen_cotizacion(cotizaciones, '9_ficheros/resumen-cotizacion.csv')
