...
emisiones_2016 = pd.read_csv('11_Pandas/8/emisiones-2016.csv', sep = ';')
emisiones_2017 = pd.read_csv('11_Pandas/8/emisiones-2017.csv', sep = ';')
emisiones_2018 = pd.read_csv('11_Pandas/8/emisiones-2018.csv', sep = ';')
emisiones_2019 = pd.read_csv('11_Pandas/8/emisiones-2019.csv', sep = ';')
